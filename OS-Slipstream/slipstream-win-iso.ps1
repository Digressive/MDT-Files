...
{
    $OSCLoc = "X:\Mike\OneDrive\apps\Oscdimg" #C:\Program Files (x86)\Windows Kits\10\Assessment and Deployment Kit\Deployment Tools\amd64\Oscdimg ##default location when ADK is installed
